...
class HelpScene(Scene):
    def setup(self):
        ...
        instructions_position = Vector2(self.screen_center_x, 
                              self.screen_center_y)
        self.instructions = SpriteNode('./assets/sprites/instructions.jpg',
                                    position = instructions_position, 
                                     parent = self, 
                                     size = self.size)
                                     
        self.text = LabelNode(text = 'Design by: Anna Devlin',
                                      font = ('Times New Roman', 20),
                                      color = 'black',
                                      parent = self,
                                      position = Vector2(self.screen_center_x, self.screen_center_y-200))
